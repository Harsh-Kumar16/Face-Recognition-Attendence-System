...
class face_recognization:
    ...
    def __init__(self,root):
        ...
        self.root.title("Facial Recognition Panel")

        # This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Userbg1.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"Images\bg1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Facial Recognition Panel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1530,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"Images\face detection.png")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                conn = mysql.connector.connect(username='root', password='password',host='localhost',database='face_recognizer', port=3306)
                cursor = conn.cursor()
