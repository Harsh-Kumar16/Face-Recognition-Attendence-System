...
class Developer:
    def __init__(self,root):
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"Images\harsh.png")
        ...
        std_b1_1 = Button(bg_img,text="Harsh Kumar",cursor="hand2",font=("tahoma",13,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

         # Attendance System button 3
        att_img_btn=Image.open(r"Images\rishabh.jpeg")
        att_img_btn=att_img_btn.resize((180,180),Image.LANCZOS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=900,y=200,width=180,height=180)

        att_b1_1 = Button(bg_img,text="Rishabh Chauhan",cursor="hand2",font=("tahoma",13,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=900,y=380,width=180,height=45)
