...
class student:
    ...
    def add_data(self):
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username="root",password="password",database="face_recognizer", port=3306)
        ...
        #load predefined data on face frontals from opencv
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path=r"Data/stdudent."+str(id)+"."+str(img_id)+".jpg"
