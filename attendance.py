...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #bg image
        img1=Image.open(r"C:\Users\Rishabh\Downloads\Face_Detection_Attendance_System_using_CV2-main\Face_Detection_Attendance_System_using_CV2-main\Images\bg1.jpg")
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(username='root', password='password',host='localhost',database='face_recognizer')
        mycursor = conn.cursor()
